...
public class DcMotorExImpl extends DcMotorImpl implements DcMotorEx{
     ...
     * @param motorType
     */
    public DcMotorExImpl(MotorType motorType, DcMotorControllerImpl controller, int portNumber, DeadWheelEncoder encoder){
        super(motorType, controller, portNumber, encoder);
    }
