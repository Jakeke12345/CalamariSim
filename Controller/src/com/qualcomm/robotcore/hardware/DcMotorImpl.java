...
public class DcMotorImpl implements DcMotor {
    ...
    private DeadWheelEncoder encoder;
    ...
    public DcMotorImpl(MotorType motorType, DcMotorControllerImpl controller, int portNumber, DeadWheelEncoder encoder){
        MOTOR_TYPE = motorType;
        MOTOR_CONFIGURATION_TYPE = new MotorConfigurationType(motorType);
        this.controller = controller;
        this.portNumber = portNumber;
    ...
    public synchronized int getCurrentPosition(){
        if (encoder!=null) return encoder.getCurrentPosition();
